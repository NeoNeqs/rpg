...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider adding the 'required' modifier or declaring as nullable.
    ...
    /// <para>One cannot change the state to a non <see cref="State.Free"/> state if current state is NOT <see cref="State.Free"/>.</para>
    /// <para>Paraphrasing: if the StateMachine is "busy" (not free) you cannot disturb it with another state with an exception*.</para>
